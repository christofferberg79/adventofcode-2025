...
class Test {
    ...
    fun day7() {
        ...
        assertEquals(40, Day7(Input("day7_ex1")).part2Alt())
        assertEquals(10357305916520, Day7(Input("day7")).part2Alt())
    }

    @Test
    fun day8() {
        assertEquals(40, Day8(Input("day8_ex1"), 10).part1())
        assertEquals(102816, Day8(Input("day8"), 1000).part1())
        assertEquals(25272, Day8(Input("day8_ex1")).part2())
        assertEquals(100011612, Day8(Input("day8")).part2())
    }

    @Test
    fun day9() {
        assertEquals(50, Day9(Input("day9_ex1")).part1())
        assertEquals(4740155680, Day9(Input("day9")).part1())
...
//        assertEquals(0, Day10(Input("day10")).part2())
    ...
    @Test
    fun day11() {
        assertEquals(5, Day11(Input("day11_ex1")).part1())
        assertEquals(534, Day11(Input("day11")).part1())
        assertEquals(2, Day11(Input("day11_ex2")).part2())
        assertEquals(499645520864100, Day11(Input("day11")).part2())
    }
}